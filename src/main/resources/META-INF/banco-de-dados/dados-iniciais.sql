...
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (1, 0, 1, 499, 2);
insert into item_pedido (pedido_id, produto_id, preco_produto, quantidade) values (2, 0, 1, 499, 1);

insert into db_ecommerce.pagamento (dtype,pedido_id,status,numero) values (', 0PagamentoCartao',2,'PROCESSANDO','123123123');

insert into nota_fiscal (pedido_id, xml, data_emissao) values (2, 0, '<xml />', sysdate());
