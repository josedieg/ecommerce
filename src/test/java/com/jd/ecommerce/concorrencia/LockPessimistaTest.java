package com.jd.ecommerce.concorrencia;
...
public class LockPessimistaTest {
    ...
    private static void log(Object obj, Object... args) {
        ConsoleCor.print(
                String.format("[LOG " + System.currentTimeMillis() + "] " + obj, args),  ConsoleCor.GREEN_BOLD_BRIGHT
        );
    }
    ...
    public void usarLockPessimistaLockModeTypePessimisticRead() {
        ...
        Thread thread1 = new Thread(runnable1);
        Thread thread2 = new Thread(runnable2);
        thread1.setName("TREAD - 1");
        thread1.start();

        esperar(1);
        thread2.setName("TREAD - 2");
        thread2.start();
